...
//CHECK PREVOIUS STATUS//

$select = "SELECT * FROM Two_factor WHERE User_id ='$_SESSION[New_user]' ORDER BY id DESC LIMIT 1";
...
$insert = "INSERT INTO Two_factor(User_id,Status,Date,Ip_add,User_agent)
