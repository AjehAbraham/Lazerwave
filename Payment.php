...
<div class="payment-link-container">
  ...
  <form method="post"  onsubmit="openConfirm(event)">
    ...
    <br>
    <input type="text" value="<?php echo number_format ($_SESSION["Amount"]);?>"  name="amount">
...
$transaction_id = "AGH" . rand(999,9999).uniqid();
...
VALUES('$result[User_id]','$transaction_id','$_SESSION[Amount]','$type','$remark','$status','$send_account_no','$re_account_no','$date','$time','$ip_add')
";
...
VALUES('$_SESSION[payment_id]','$transaction_id','$_SESSION[Amount]','$type','$remark','$status','$send_account_no','$re_account_no','$date','$time','$ip_add')
";
