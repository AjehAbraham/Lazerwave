...
$(document).ready(function (e) {
  ...
  $("#FormData_otp").on('submit', (function(e){
  ...
  processData: false,
    ...
    document.querySelector(".loader-overlay-refresh").style.display= "none";
       ...
       document.querySelector(".Otp_error_message").innerHTML = Data;
  
if(Data == "\r\nSuccess"){
  document.querySelector(".Otp_error_message").innerHTML = "";
...
var form = $("#FromData_request");
var url = 'Process/Auth-security/request-email-otp';
...
document.querySelector(".request_error_message").innerHTML  = data.responseText;    
