...
VALUES('$_SESSION[New_user]','$transaction_id','$_SESSION[AMOUNT]','$type','$remark','$status','$from','$to','$date','$time','$ip_addr')
...
$remark = "+ Credit";
   ...
   $type = "+ CREDIT from " .$user['Surname'] . " ". $user['First_name'];
    ...
    VALUES('$_SESSION[receiver_id]','$transaction_id','$_SESSION[AMOUNT]','$type','$remark','$status','$from','$to','$date','$time','$ip_addr')
