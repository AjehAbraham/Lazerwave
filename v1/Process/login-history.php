...
$loginHistory = "INSERT INTO Login_history(User_id,Date,Time,Ip_addr,User_agent)

VALUES('$_SESSION[New_user]','$date','$time','$ip','$user_agent')
";



if(mysqli_query($conn,$loginHistory)){
