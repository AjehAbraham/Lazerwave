...
<p>From<b><?php echo $user["Surname"] ." " .$user["Last_name"]. " ". $user["First_name"] ?></b></p>
<p>To<b><?php echo   $_SESSION["Surname"] . " ".$_SESSION["Last_name"] . " ".  $_SESSION["First_name"] ; ?></b></p>
<p>Transaction_id<b><?php echo
$_SESSION["Transaction_id"] ?></b></p>

<p>Message<b><?php echo $_SESSION["Type_remark"] . "-" .($_SESSION["remark"] ); ?></b></p>
